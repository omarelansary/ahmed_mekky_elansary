  ...
  return (
    <article className="rounded-lg border border-black/10 dark:border-white/10 p-4 h-full flex flex-col">
      ...
      <div className="mt-4 flex gap-3 mt-auto">
        <Link href={href} className="text-sm rounded border border-black/10 dark:border-white/20 px-3 py-1">
        ...
        {item.external_url && (
          <a
            ...
            className="text-sm rounded border border-black/10 dark:border-white/20 px-3 py-1"
          >
            {locale === "en" ? "External PDF" : "رابط خارجي"}
          </a>
        )}
      </div>
    </article>
