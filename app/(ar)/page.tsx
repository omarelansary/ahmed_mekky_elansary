...
export default function ArabicHome() {
  ...
  return (
    <>
      ...
      />
      <section className="section rounded-2xl bg-[url('/texture.png')] bg-cover bg-no-repeat/cover bg-[length:120%]">
        <div className="grid gap-8 md:grid-cols-[1fr,1.5fr] items-center">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight ui">أحمد الأنصاري</h1>
